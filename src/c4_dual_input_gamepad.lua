...
local M = {version='0.5.0-exp05', capture=false, tick=0, elapsed_ms=0,
...
print('[C4 Dual Input EXP05] F6 enable/disable; RMB/LT/L2 Deploy; LMB/RT/R2 Detonate; F7 marker. Log: '..M.log_name)
return M
