...
def main():
    ...
    old=json.loads((ROOT/'evidence/exp05-v0.5.0-tested-release/evidence/gamepad-offline-tests.json').read_text())
    files=set(old['files'])|{'src/gameplay_guard.lua','src/automatic_tick.lua','src/c4_dual_input_auto.lua',
        'scripts/assemble_automatic.py','scripts/check_automatic.py','scripts/assemble_context.py',
        'tests/test_automatic.lua','tests/test_automatic_collection.py','docs/AUTOMATIC_README.txt'}
    report=dict(evidence_kind='MOCK_AND_STATIC',source_sha256=source_hash,
        ...
        game_executed=False,automatic_activation_live_verified=False,window_guard_live_verified=False,
