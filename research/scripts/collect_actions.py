...
def main():
    ...
    p.add_argument('--phase',choices=['exp03','exp04','exp05','exp06'],default='exp03');args=p.parse_args()
    ...
    directory=ROOT/'evidence'/('live-'+phase+'-'+ring.get('session_id',source.stem)+'-'+digest[:12])
